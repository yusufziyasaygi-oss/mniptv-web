(() => {
        ...
        <section class="login-panel">
          ...
          <section class="public-download-card" aria-label="MN IPTV uygulamalarını indir">
            ...
            <div class="public-download-links">
              <a href="downloads/MN-IPTV-macOS.dmg" download><b></b><span><strong>macOS</strong><small>DMG</small></span></a>
              <a href="downloads/MN-IPTV-Windows.exe" download><b>⊞</b><span><strong>Windows</strong><small>EXE</small></span></a>
              <a href="downloads/MN-IPTV-Android.apk" download><b>◆</b><span><strong>Android</strong><small>APK</small></span></a>
              <a href="downloads/MN-IPTV-TV.apk" download><b>▣</b><span><strong>Android TV</strong><small>APK</small></span></a>
            </div>
          </section>
        </section>
      </main>`;
  ...
  function renderApps(){
    const apps=[
      {name:'macOS',file:'downloads/MN-IPTV-macOS.dmg',format:'DMG',icon:'',desc:'Mac için masaüstü uygulaması'},
      {name:'Windows',file:'downloads/MN-IPTV-Windows.exe',format:'EXE',icon:'⊞',desc:'Windows için masaüstü uygulaması'},
      {name:'Android',file:'downloads/MN-IPTV-Android.apk',format:'APK',icon:'◆',desc:'Android telefon ve tabletler için'},
      {name:'Android TV',file:'downloads/MN-IPTV-TV.apk',format:'APK',icon:'▣',desc:'Android TV ve Google TV için'}
    ];
    return `<section class="apps-download-hero"><div><span class="eyebrow">MN IPTV</span><h2>Cihazına kur</h2><p>Platformunu seç. Dosya doğrudan bu siteden indirilir.</p></div></section>
      <div class="apps-download-grid">${apps.map(a=>`<a class="app-download-card" href="${a.file}" download><div class="app-download-icon">${a.icon}</div><div class="app-download-copy"><strong>${a.name}</strong><span>${a.desc}</span><small>${a.format} · İndirmek için tıkla</small></div><div class="app-download-arrow">↓</div></a>`).join('')}</div>
      <section class="settings-card apps-download-note"><h3>Kurulum dosyaları</h3><p>Bu sayfadaki bağlantılar doğrudan MN IPTV dağıtım dosyalarına gider. Web sürümünü kullanmaya devam etmek istersen herhangi bir şey indirmen gerekmez.</p><a class="checksum-link" href="downloads/SHA256SUMS.txt" download>SHA-256 doğrulama dosyasını indir</a></section>`;
  }
